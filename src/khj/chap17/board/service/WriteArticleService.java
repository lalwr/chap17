package khj.chap17.board.service;
...
import khj.chap17.board.dao.ArticleDao;
import khj.chap17.board.model.Article;
import khj.chap17.board.model.WritingRequest;
import khj.jdbc.JdbcUtil;
import khj.jdbc.connection.ConnectionProvider;
	...
	public Article write(WritingRequest writingRequest) throws IdGenerationFailedException {
		...
		try {
			...
			if (articleId == -1) {
				...
				throw new RuntimeException("DB 삽입 완료 : " + articleId);
			}
			conn.commit();
